...
def clear_screen():
    """Membersihkan layar sesuai dengan sistem operasi."""
...
class Character:
    ...
    def take_damage(self, damage):
        """Mengurangi HP karakter berdasarkan damage yang diterima."""
...
class EnemyAI(Character):
    """Kelas untuk musuh dengan AI sederhana."""
    def choose_action(self, turn_count):
        """AI memilih aksi berdasarkan kondisi."""
...
class Game:
    ...
    def display_status(self):
        """Menampilkan status HP pemain dan musuh."""
    ...
    def use_skill(self, user, target):
        """Menggunakan skill spesial dengan efek gambling."""
